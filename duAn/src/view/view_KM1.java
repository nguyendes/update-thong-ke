 ...
 * @author Admin
 */
public class view_KM1 extends javax.swing.JFrame {
    ...
    public void fillTable(ArrayList<model.ChiTietKM> list) {
        mol = (DefaultTableModel) tbl_danhsach.getModel();
        mol.setRowCount(0);
        for (model.ChiTietKM x : list) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_KM1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
model.ChiTietKM readForm() {
        ...
        try {
            NgayBatDau = (Date) dateFormat.parse(txt_date1.getText().trim());
            NgayKetThuc = (Date) dateFormat.parse(txt_date2.getText().trim());
        } catch (ParseException e) {
            e.printStackTrace(); // Xử lý ngoại lệ nếu có lỗi khi parse ngày tháng
            return null; // Hoặc xử lý theo ý của bạn khi có lỗi
        }
        ...
        return new ChiTietKM(MaKM, TenKM, MaSP, NgayBatDau, NgayKetThuc, TiLeGiam, GiamToiDa);
